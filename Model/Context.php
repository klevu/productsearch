...
class Context extends DataObject
{
     ...
     * @param Klevu_Product_Delete $klevuProductDelete
     * @param Klevu_Product_Update $klevuProductUpdate
     * @param Klevu_Product_Add $klevuProductAdd
     * @param Klevu_Customer_Group $klevuCustomerGroup
     * @param Klevu_Action_Feature $klevuActionFeature
