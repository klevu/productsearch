...
use Klevu\Search\Model\Sync as KlevuSyncModel;
...
class ConfigurableTest extends TestCase
{
     ...
     * @magentoDataFixture loadConfigurableProductAttributeFixtures
     * @magentoDataFixture loadConfigurableProductFixtures
     * @magentoDataFixture loadConfigurableOrderFixtures
     * @magentoDataFixture loadConfigurableKlevuOrderFixtures
     */
    public function testConfigurableProductOrderSync()
    {
        $this->setupPhp5();
        ...
        $this->producttrackingActionMock->method('execute')
            ->willReturnCallback(function ($parameters) use ($childProduct, $parentProduct, $response) {
                ...
                $this->assertSame(30.0000, $parameters['klevu_salePrice']);

                $this->assertArrayHasKey('klevu_productId', $parameters);
                $this->assertSame($parentProduct->getId() . '-' . $childProduct->getId(), $parameters['klevu_productId']);
                ...
                $this->assertSame($childProduct->getId(), $parameters['klevu_productVariantId']);
    ...
    /**
     * Loads configurable order creation scripts because annotations use a relative path
     *  from integration tests root
     */
    public static function loadConfigurableKlevuOrderFixtures()
    {
        require __DIR__ . '/_files/klevuOrderSync_configurableFixtures.php';
    }
     ...
     *  from integration tests root
     */
    public static function loadConfigurableOrderFixtures()
    {
        require __DIR__ . '/_files/order_configurableFixtures.php';
    }

    /**
     * Rolls back configurable order creation scripts because annotations use a relative path
     *  from integration tests root
     */
    public static function loadConfigurableOrderFixturesRollback()
    {
        require __DIR__ . '/_files/order_configurableFixtures_rollback.php';
    }

    /**
     * Loads configurable product attribute creation scripts because annotations use a relative path
     *  from integration tests root
     */
    public static function loadConfigurableProductAttributeFixtures()
    {
        require __DIR__ . '/_files/productAttributeFixtures.php';
    }
