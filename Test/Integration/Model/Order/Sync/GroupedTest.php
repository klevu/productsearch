...
class GroupedTest extends TestCase
{
     ...
     * @magentoDataFixture loadGroupedOrderFixtures
     * @magentoDataFixture loadGroupedKlevuOrderFixtures
     */
    public function testGroupedProductOrderSync()
    {
        $this->setupPhp5();
        ...
        $this->producttrackingActionMock->method('execute')
            ->willReturnCallback(function ($parameters) use ($parentProduct, $response) {
                ...
                $this->assertSame(100.0000, $parameters['klevu_salePrice']);
    ...
    /**
     * Loads grouped order creation scripts because annotations use a relative path
     *  from integration tests root
     */
    public static function loadGroupedKlevuOrderFixtures()
    {
        require __DIR__ . '/_files/klevuOrderSync_groupedFixtures.php';
    }
     ...
     *  from integration tests root
     */
    public static function loadGroupedOrderFixtures()
    {
        require __DIR__ . '/_files/order_groupedFixtures.php';
    }

    /**
     * Rolls back grouped order creation scripts because annotations use a relative path
     *  from integration tests root
     */
    public static function loadGroupedOrderFixturesRollback()
    {
        require __DIR__ . '/_files/order_groupedFixtures_rollback.php';
    }
