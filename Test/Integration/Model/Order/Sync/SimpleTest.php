...
class SimpleTest extends TestCase
{
     ...
     * @magentoDataFixture loadSimpleOrderFixtures
     * @magentoDataFixture loadSimpleKlevuOrderFixtures
     */
    public function testSimpleProductOrderSync()
    {
        $this->setupPhp5();
        ...
        $this->producttrackingActionMock->method('execute')
            ->willReturnCallback(function ($parameters) use ($product, $response) {
                ...
                $this->assertSame($product->getId(), $parameters['klevu_productGroupId']);

                $this->assertArrayHasKey('klevu_productVariantId', $parameters);
                $this->assertSame($product->getId(), $parameters['klevu_productVariantId']);
    ...
    /**
     * Loads simple order creation scripts because annotations use a relative path
     *  from integration tests root
     */
    public static function loadSimpleKlevuOrderFixtures()
    {
        require __DIR__ . '/_files/klevuOrderSync_simpleFixtures.php';
    }
     ...
     *  from integration tests root
     */
    public static function loadSimpleOrderFixtures()
    {
        require __DIR__ . '/_files/order_simpleFixtures.php';
    }

    /**
     * Rolls back simple order creation scripts because annotations use a relative path
     *  from integration tests root
     */
    public static function loadSimpleOrderFixturesRollback()
    {
        require __DIR__ . '/_files/order_simpleFixtures_rollback.php';
    }
