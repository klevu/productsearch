...
class BundleProductTest extends TestCase
{
    ...
    public function test_CatalogExcludes_DisplayBoth_SearchExcludes()
    {
        ...
        $this->assertSame(5.99, $salePrice, 'Sale Price');
        $this->assertSame(5.99, $startPrice, 'Start Price');
        $this->assertSame(20.00, $toPrice, 'To Price');
        $this->assertSame(5.99, $price, 'Price');
    }
    ...
    public function test_CatalogExcludes_DisplayBoth_SearchIncludes()
    {
        ...
        $this->assertSame(7.19, $salePrice);
        $this->assertSame(7.19, $startPrice);
        $this->assertSame(24.00, $toPrice);
        $this->assertSame(7.19, $price);
    }
    ...
    public function test_CatalogIncludes_DisplayBoth_SearchExcludes()
    {
        ...
        $this->assertSame(4.99, $salePrice);
        $this->assertSame(4.99, $startPrice);
        $this->assertSame(16.67, $toPrice);
        $this->assertSame(4.99, $price);
    }
    ...
    public function test_CatalogIncludes_DisplayBoth_SearchIncludes()
    {
        ...
        $this->assertSame(5.99, $salePrice);
        $this->assertSame(5.99, $startPrice);
        $this->assertSame(20.00, $toPrice);
        $this->assertSame(5.99, $price);
    }
    ...
    {
        include __DIR__ . '/_files/bundleProduct_DynamicPrice_Fixtures.php';
    }
    ...
    {
        include __DIR__ . '/_files/bundleProduct_DynamicPrice_Fixtures_rollback.php';
    }
