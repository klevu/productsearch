...
include __DIR__ . '/bundleProduct_DynamicPrice_TierPrices_Fixtures_rollback.php';
...
$tirePrices = [
    'klevu_bundle_product_test' => [
        'website_id' => $website1->getId(), // set for all websites
...
foreach ($tirePrices as $sku => $tirePrice) {
    ...
    if ($tirePrice['percentage_value']) {
        $extensionAttributes->setPercentageValue($tirePrice['value']);
    }
