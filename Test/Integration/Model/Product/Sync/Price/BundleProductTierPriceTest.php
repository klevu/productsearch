...
class BundleProductTierPriceTest extends TestCase
{
    /**
    ...
    public function test_CatalogExcludes_DisplayBoth_SearchExcludes()
    {
        ...
        $product = $this->getProduct('klevu_bundle_product_test', $store->getId());
        ...
        $this->assertSame(5.39, $salePrice, 'Sale Price');
        $this->assertSame(5.39, $startPrice, 'Start Price');
        $this->assertSame(18.00, $toPrice, 'To Price');
        $this->assertSame(5.39, $price, 'Price');
        foreach ($groupPrices as $groupPrice) {
            $this->assertSame('NOT LOGGED IN', $groupPrice['label']);
            // magento returns 0.0 for each customer tier price for bundle.
            $this->assertSame(0.0, (float)$groupPrice['values']);
        }
        $this->assertSame('salePrice_-0:0', $otherPrices);
    }
    ...
    public function test_CatalogExcludes_DisplayBoth_SearchIncludes()
    {
        ...
        $this->assertSame(6.47, $salePrice);
        $this->assertSame(6.47, $startPrice);
        $this->assertSame(21.6, $toPrice);
        $this->assertSame(6.47, $price);
        foreach ($groupPrices as $groupPrice) {
            $this->assertSame('NOT LOGGED IN', $groupPrice['label']);
            // magento returns 0.0 for each customer tier price for bundle.
            $this->assertSame(0.0, (float)$groupPrice['values']);
    ...
    public function test_CatalogIncludes_DisplayBoth_SearchExcludes()
    {
        ...
        $this->assertSame(4.49, $salePrice);
        $this->assertSame(4.49, $startPrice);
        $this->assertSame(15.0, $toPrice);
        $this->assertSame(4.49, $price);
        foreach ($groupPrices as $groupPrice) {
            $this->assertSame('NOT LOGGED IN', $groupPrice['label']);
            // magento returns 0.0 for each customer tier price for bundle.
            $this->assertSame(0.0, (float)$groupPrice['values']);
    ...
    public function test_CatalogExcludes_DisplayExcludes()
    {
        ...
        foreach ($groupPrices as $groupPrice) {
            $this->assertSame('NOT LOGGED IN', $groupPrice['label']);
            // magento returns 0.0 for each customer group price for bundle.
            $this->assertSame(0.0, (float)$groupPrice['values']);
        }
        $this->assertSame('salePrice_-0:0', $otherPrices);
    }
    ...
    {
        include __DIR__ . '/_files/bundleProduct_DynamicPrice_TierPrices_Fixtures.php';
    }
    ...
    {
        include __DIR__ . '/_files/bundleProduct_DynamicPrice_TierPrices_Fixtures_rollback.php';
    }
