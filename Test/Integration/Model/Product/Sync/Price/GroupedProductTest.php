...
class GroupedProductTest extends TestCase
{
    ...
    public function test_CatalogExcludes_DisplayBoth_SearchExcludes()
    {
        ...
        $product = $this->getProduct('klevu_grouped_product_test', $store->getId());
        ...
        $this->assertSame(4.99, $salePrice, 'SalePrice');
        $this->assertSame(4.99, $startPrice, 'StartPrice');
        $this->assertNull($toPrice, 'To Price');
        $this->assertSame(4.99, $price, 'Price');
        $this->assertNull($groupPrices, 'Group Prices');
        $this->assertSame('', $otherPrices, 'Other Prices');
    }
    ...
    public function test_CatalogExcludes_DisplayBoth_SearchIncludes()
    {
        ...
        $this->assertSame(5.99, $salePrice, 'SalePrice');
        $this->assertSame(5.99, $startPrice, 'StartPrice');
        $this->assertNull($toPrice, 'To Price');
    ...
    public function test_CatalogIncludes_DisplayBoth_SearchExcludes()
    {
        ...
        $this->assertSame(4.16, $salePrice, 'SalePrice');
        $this->assertSame(4.16, $startPrice, 'StartPrice');
        $this->assertNull($toPrice, 'To Price');
        $this->assertSame(4.16, $price, 'Price');
        $this->assertNull($groupPrices, 'Group Prices');
        $this->assertSame('', $otherPrices, 'Other Prices');
    }
    ...
    private function getProduct($sku, $storeId)
    {
        ...
        if ('klevu_grouped_product_test' !== $sku) {
