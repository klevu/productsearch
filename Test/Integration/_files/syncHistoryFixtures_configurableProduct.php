...
include __DIR__ . '/syncHistoryFixtures_configurableProduct_rollback.php';
...
$parentProduct = $product = $productRepository->get('klevu_configurable_1');
foreach ($productSkus as $productSku) {
    ...
    foreach ($storeCodes as $storeCode) {
        ...
        $fixtures[] = [
            ...
            History::FIELD_PARENT_ID => ($parentProduct->getId() !== $product->getId()) ? $parentProduct->getId() : 0,
