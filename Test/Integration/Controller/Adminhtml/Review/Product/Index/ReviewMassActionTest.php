...
class ReviewMassActionTest extends AbstractBackendControllerTestCase
{
    /**
    ...
    public function testDelete_Approved_WithRating()
    {
        ...
        $request->setParam('ret', 'index');
        $request->setPostValue([
            'reviews' => $reviewFixture->getId(),
            'massaction_prepare_key' => 'reviews',
        ]);

        $this->dispatch($this->getAdminFrontName() . '/review/product/massDelete');
     ...
     */
    public function testDelete_Disapproved_WithoutRating()
    {
        $this->setupPhp5();
    ...
    public function testUpdateStatus_PendingToApproved_UpdateWithRating()
    {
        ...
        $this->dispatch($this->getAdminFrontName() . '/review/product/massUpdateStatus/');
