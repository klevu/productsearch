...
class SyncNowTest extends AbstractBackendControllerTestCase
{
    use SyncApiMock;
     ...
     * @var string
     */
    protected $uri = '/klevu_search/syncproduct/now';
    /**
    ...
    public function testResponseIsRedirectToIndex()
    {
        ...
        $this->assertRedirectToGird($store);
        $this->assertMessageShows(
            'Product Sync triggered for product SKU (' . $product->getSku() . ') in ' . $store->getName()
        );
    }
