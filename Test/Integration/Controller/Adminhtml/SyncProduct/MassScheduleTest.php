...
class MassScheduleTest extends AbstractBackendControllerTestCase
{
     ...
     * @var string
     */
    protected $uri = '/klevu_search/syncproduct/massschedule';
    /**
     ...
     */
    public function testSimpleProductScheduleSyncAndResponseIsRedirectToIndex()
    {
        $this->setUpPhp5();
        ...
        $this->assertRedirectToGird($store);
        $this->assertMessageShows(
            count($uniqueProductIds)  . ' Products have been added to Sync Schedule in ' . $store->getName()
        );
    }
