...
use Klevu\Search\Setup\Patch\Data\CreateRatingProductAttribute;
...
class CreateRatingProductAttributeTest extends TestCase
{
    /**
     * @var ObjectManager
     */
    ...
    public function testAttributeIsNotCreatedIfItExists()
    {
        ...
        $patch = $this->objectManager->create(CreateRatingProductAttribute::class, [
