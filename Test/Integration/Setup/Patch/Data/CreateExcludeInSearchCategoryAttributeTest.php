...
use Klevu\Search\Setup\Patch\Data\CreateExcludeInSearchCategoryAttribute;
...
class CreateExcludeInSearchCategoryAttributeTest extends TestCase
{
    /**
     * @var ObjectManager
     */
    ...
    public function testAttributeIsNotCreatedIfItExists()
    {
        ...
        $patch = $this->objectManager->create(CreateExcludeInSearchCategoryAttribute::class, [
