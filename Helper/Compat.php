...
class Compat extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function __construct(
        \Magento\Catalog\Model\Factory $catalogModelFactory,
     ...
     */
    public function getProductUrlRewriteSelect(array $product_ids, $store_id)
    {
        $resource = $this->_frameworkModelResource;
        return $resource->getConnection("core_write")->select()
            ->from($resource->getTableName("url_rewrite"), ["entity_id", "request_path"])
            ...
            ->order("metadata ". \Magento\Framework\Data\Collection::SORT_ORDER_ASC);
    }
     ...
     * @return \Magento\Framework\Db\Select
     */
    public function getCategoryUrlRewriteSelect(array $category_ids, $store_id)
    {
        $resource = $this->_frameworkModelResource;
        return $resource->getConnection("core_write")->select()
            ->from($resource->getTableName("url_rewrite"), ["entity_id", "request_path"])
