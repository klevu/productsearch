 ...
 */
namespace Klevu\Search\Block\Adminhtml\Form\Field\Trigger;

class Button extends \Magento\Config\Block\System\Config\Form\Field {
    
    protected $_template = 'klevu/search/form/field/trigger/button.phtml';
    ...
    protected function _getElementHtml(\Magento\Framework\Data\Form\Element\AbstractElement $element) {
        ...
        $this->addData(array(
            ...
            "destination_url" => $this->getUrl("klevu_search/trigger/all", $url_params)
        ));
